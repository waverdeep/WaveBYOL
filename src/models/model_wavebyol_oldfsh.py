    ...
    if model_name == "resnet50":
        ...
        feature_extractor_model.add_module(
            ...
            nn.Sequential(
                ...
                torchvision.models.resnet152(pretrained=pretrain).bn1,
                torchvision.models.resnet152(pretrained=pretrain).relu,
                torchvision.models.resnet152(pretrained=pretrain).layer1,torchvision.models.resnet152(pretrained=pretrain).conv1,
                torchvision.models.resnet152(pretrained=pretrain).layer2,
            )
        )
...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        out_s = out.unsqueeze(1)
        # print(out.size())

        out_cat = F.normalize(out_s, dim=-1, p=2)
