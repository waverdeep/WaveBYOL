...
class Encoder(nn.Module):
    def __init__(self, input_dim, hidden_dim, stride, filter_size, padding, feature_extractor_model, pretrain):
        ...
        # resnet50
        # self.adaptive_average_pooling = nn.AdaptiveAvgPool2d((6, 1))
        # self.adaptive_max_pooling = nn.AdaptiveMaxPool2d((6, 1))

        # h2
        self.adaptive_average_pooling = nn.AdaptiveAvgPool2d((10, 1))
        self.adaptive_max_pooling = nn.AdaptiveMaxPool2d((10, 1))
