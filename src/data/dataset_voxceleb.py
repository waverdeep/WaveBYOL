...
class VoxCelebWaveformDatasetByWaveBYOLTypeA(Dataset):
    def __init__(self, file_path, audio_window=20480, sampling_rate=16000, augmentation=[1, 2, 3, 4, 5, 6],
                 augmentation_count=5, speaker_filelist="./dataset/voxceleb01-SI-label.txt", config=None):
        super(VoxCelebWaveformDatasetByWaveBYOLTypeA, self).__init__()
